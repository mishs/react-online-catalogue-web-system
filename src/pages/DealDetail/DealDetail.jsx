        ...
        <div className="deal-detail_container display-flex h-between">
            {
                ...
                <div className="deal-details-left">
                    <Detail thumbnail={dealDetail.gameInfo.thumb} title={dealDetail.gameInfo.name} shopName={dealDetail.gameInfo.publisher} price={dealDetail.gameInfo.retailPrice} salePrice={dealDetail.gameInfo.salePrice} isOnSale={dealDetail.gameInfo.salePrice?true:false} />
                </div>

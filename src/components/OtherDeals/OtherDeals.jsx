        ...
        <OtherDealsStyles>
            <h4 className="font-lg font-500">Other deals for this game</h4>
            {
                cheaperDeals.map(deal=>{
                    return (
                        <div className="deal display-flex h-between v-center" key={deal.dealID}>
                            <div>
                                <h4 className="font-md font-500">Steam</h4>
                                <Prices price={deal.retailPrice} salePrice={deal.salePrice} isOnSale={deal.salePrice?true:false} />
                            </div>
                            <Button
                            onClick={
                                ()=>{
